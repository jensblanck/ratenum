...
-- | An infinite tree containing all positive rational numbers without
-- duplicates.
...
-- | List of positive rational numbers without duplicates generated by
-- listing the Stern-Brocot tree in levels. This is @rat5@ in Gibbins
-- et al. paper.
ratPosSB :: [Rational]
ratPosSB = concat $ treeLevels stern_brocot

-- | List of positive rational numbers without duplicates generated by
-- listing the Stern-Brocot tree in levels. This does not construct
-- the tree explicitly. This is @rat5@ in Gibbins et al. paper.
ratPosSB' :: [Rational]
ratPosSB' = concat (unfolds infill [(0,1),(1,0)])
...
-- | List of positive rational numbers without duplicates generated by
-- listing the Calkin-Wilf tree in levels. This is @rat6@ in Gibbins et al. paper.
ratPosCW :: [Rational]
ratPosCW = concat $ treeLevels calkin_wilf

-- | List of positive rational numbers without duplicates generated by
-- listing the Calkin-Wilf tree in levels. This does not construct
-- the tree explicitly. This is @rat7@ in Gibbins et al. paper.
ratPosCW' :: [Rational]
ratPosCW' = iterate next 1

next :: Rational -> Rational
next x = recip $ fromInteger n + 1 - y
  where (n,y) = properFraction x

-- | List of all rational numbers without duplicates generated by
-- listing the Calkin-Wilf tree in levels. It prepends 0 and
-- interleaves the negative rationals. This does not construct the
-- tree explicitly. This is @rat8@ in Gibbins et al. paper.
ratCW :: [Rational]
ratCW = iterate next0 0
  where next0 0 = 1
        next0 x
          | x > 0     = negate x
...
-- | List of positive rational numbers as regular continued fractions
-- without duplicates generated by listing the Calkin-Wilf tree in
-- levels. This does not construct the tree explicitly. This is @rat8@
-- in Gibbins et al. paper.
ratCF :: [CF]
ratCF = iterate (recipcf . nextcf ) [1]
